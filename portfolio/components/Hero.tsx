  ...
  return (
    <div className="pb-20 pt-36">
      <div>
        ...
        md:-left-32 md:-top-20 h-[80vh] w-[50vw]" fill="purple"/>

        <Spotlight className='-top-28 -left-80
        h-[80vh] w-[50vw]' fill="blue"/>
      </div>

        <div className="h-screen w-full dark:bg-purple-100
        ...
        {/* Radial gradient for the container to give a faded look */}
            ...
            flex items-center justify-center dark:bg-purple-100
        ...
        <div className="flex justify-center relative my-20 z-10">
            ...
            flex flex-col items-center justify-center">
                ...
                text-center text-pink-100 max-w-80'>
                ...
                <TextGenerateEffect 
                    ...
                    mb-4 text-sm md:text-lg lg:text-2xl">
                        Hi, I'm Chez'lene, a full stack developer based in the United States
                    </p>
